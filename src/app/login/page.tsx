...
export default function LoginPage() {
  ...
  return (
    <div style={{
      minHeight: '80vh', // Accounts for header/footer if they are present
      display: 'flex',
      alignItems: 'center',
      justifyContent: 'center',
      padding: '40px 20px',
      background: '#f8f9fa' // Light background to contrast with the dark card
    }}>
      <div style={{
        display: 'flex',
        flexDirection: 'row',
        ...
        <div style={{
          ...
          <div style={{ position: 'relative', zIndex: 1 }}>
            ...
            <p style={{ fontSize: '16px', color: '#c5d9c2', marginBottom: '40px', lineHeight: 1.6 }}>
              Welcome to your store\'s command center. Manage products, optimize SEO, and handle orders all in one powerful dashboard.
            </p>
